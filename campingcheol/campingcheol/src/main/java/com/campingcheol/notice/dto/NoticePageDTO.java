...
public class NoticePageDTO {
   ...
   //회원검색
   private String table; //userInfo전체회원 userDrop탈퇴회원
   
   //상품검색
   private String state; //판매여부
   ...
   //회원검색, 공지사항검색
   public NoticePageDTO(int currentPage, int totalCount, String table, String searchKey, String searchWord) {
      this(currentPage, totalCount);
      this.table = table;
      this.searchKey = searchKey;
      this.searchWord = searchWord;
   ...
   //상품검색
   public NoticePageDTO(int currentPage, int totalCount, String state, String category, String searchKey, String searchWord) {
      this(currentPage, totalCount);
      this.state = state;
