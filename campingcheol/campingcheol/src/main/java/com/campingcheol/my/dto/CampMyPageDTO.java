package com.campingcheol.my.dto;

import org.springframework.stereotype.Component;

	@Component
	public class CampMyPageDTO {
		...
		public CampMyPageDTO() {

		}

		public CampMyPageDTO(int currentPage, int totalCount) {
		...
		public CampMyPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
